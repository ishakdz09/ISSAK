...
<script>
    ...
    function telegramNotify(data) {
        ...
        $.ajax({
            url: 'dashboard_api/get_single_channel_details.php',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(jsonObjects),
            dataType: 'json'
        ...
        .done(function (response) {
            ...
            sendTelegramNotification(response.name, response.description, response.banner);
        })
