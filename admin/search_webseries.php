...
<head>
    ...
    <title>Dooo - Search & Import Web Series</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="page-title-box">
                            ...
                            <h4 class="font-size-18">Search & Import Web Series</h4>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-body">
            ...
            <h3 class="card-title mt-0">Search Web Series (<a href="https://www.themoviedb.org/tv"
    ...
    function fetch_webseries_ids(keyword) {
        Swal.fire({
            ...
            onOpen: ()=>{
                ...
                $.ajax({
                    type: 'GET',
                    url: "https://api.themoviedb.org/3/search/tv?api_key=1bfdbff05c2698dc917dd28c08d41096&query="+ keyword +"&language=" + tmdb_language,
                    dataType: 'json',
                    success: function (response) {
                        Swal.close();
