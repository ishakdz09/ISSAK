                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-body">
                                ...
                                <h3 class="card-title mt-0">Privecy Policy</h3>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 row justify-content-end">
                                        <button class="btn btn-primary dropdown-toggle waves-effect waves-light"
                                            onclick="Save()" id="create_btn" type="submit"
...
function OnLoad() {
            $.ajax({
                ...
                success: function (response) {
                    var PrivecyPolicy = response.PrivecyPolicy;
                    $('#summernote').summernote('code', PrivecyPolicy);
                }
...
function Save() {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "dashboard_api/save_pp.php",
                contentType: 'application/json',
                data: JSON.stringify(jsonObjects),
                dataType: 'text',
                success: function (response) {
                    if (response == "Privecy Policy Data Updated successfully") {
                        swal.fire({
                            title: 'Successful!',
                            text: 'Privacy Policy Data Updated Successfully!',
                            type: 'success',
