    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-lg-inline-block">
                ...
                <button type="button" class="btn header-item noti-icon waves-effect" data-toggle="modal" data-target="#QRCodeModal">
...
<div class="modal fade" id="QRCodeModal" tabindex="-1" aria-labelledby="QRCodeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" id="QRCode-modal-content">
            <div class="modal-header border-bottom-0">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <h4 class="text-primary">QRCODE !</h4>
                            <p class="text-muted font-size-14 mb-4">Scan QR Code To Login in Admin App.</p>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a class="dripicons-broadcast" href="telegram_announcement.php">
                                <?php echo Translation::of('Announcement'); ?></a></li>

                        <li><a class="typcn typcn-cog" href="telegram_setting.php">
                                <?php echo Translation::of('Setting'); ?></a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a class="mdi mdi-all-inclusive" href="sub_plan.php">
                            Plans</a></li>

                        <li><a class="mdi mdi-settings" href="sub_setting.php">
                            Settings</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a class="mdi mdi-database-import" href="database.php">
                            Database</a></li>
        ...
        $.ajax({
            ...
            success: function (response100) {
                ...
                var jsonObjects = {
                    ...
                    "api_key": response100.api_key,
                    "license_code": response100.license_code,
                    "Email": '<?php echo $_SESSION['Email']; ?>',
                    "Password": '<?php echo $_SESSION['Password']; ?>'
                };
                jQuery('#qrcode').qrcode({
		            text  : btoa(JSON.stringify(jsonObjects))
	            });
            }
        });
    }
