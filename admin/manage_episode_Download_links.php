...
<head>
    ...
    <title>Dooo - Manage Episode Download Links</title>
                                ...
                                <table id="datatable" class="table table-striped"
                                    ...
                                    if ($conn->connect_error) {
                                     die("Connection failed: " . $conn->connect_error);
                                       ...
                                       $sql = "SELECT * FROM episode_download_links WHERE episode_id = $ID ORDER BY link_order";
...
<script>
    ...
    function add_download_links() {
        ...
        $.ajax({
            type: 'POST',
            url: "dashboard_api/add_episode_download_links.php",
    ...
    function Load_Link_Data(ID) {
        ...
        $.ajax({
            type: 'POST',
            url: "dashboard_api/get_episoad_download_link_details.php",
            contentType: 'application/json',
            data: JSON.stringify(jsonObjects),
            dataType: 'json',
    ...
    function Update_Link_Data() {
        ...
        $.ajax({
            type: 'POST',
            url: "dashboard_api/update_episode_download_link_data.php",
            contentType: 'application/json',
            data: JSON.stringify(jsonObjects),
            dataType: 'text',
    ...
    function Delete_DownloadLink(ID) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "dashboard_api/delete_episode_download_link.php",
                    contentType: 'application/json',
                    data: JSON.stringify(jsonObjects),
                    dataType: 'text',
