...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            ...
            $sql = "INSERT INTO movie_download_links (name, size, quality, link_order, movie_id, url, type, download_type, status)
                                        VALUES ('$Label', '$Size', '$Quality', '$Order', '$Movie_id', '$Url', '$Source', '$download_type', '$Status')";
